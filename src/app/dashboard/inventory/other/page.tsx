...
import { Package } from 'lucide-react'; // Default icon for "Other"
...
export default async function OtherInventoryPage() {
  ...
  return (
    <div className="container mx-auto py-2">
      <PageHeader
        title="Inventário de Outros Equipamentos"
        icon={Package}
        description={`Visualizando todos os equipamentos classificados como "${TARGET_TYPE_NAME}".`}
      />
      <InventoryClientPage
        initialItems={items}
